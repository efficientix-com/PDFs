...
<td align="right" colspan="2"><span class="title">Pago #${record.tranid}</span></td>
    ...
    <td colspan= "1">
        <table style="width:100%;">
            ...
            <#else>
                <tr>
                    <#assign razonSocial  = record.customer.companyname >
                    <#if razonSocial?has_content == false>
                        <#assign razonSocial  = record.customer.firstname + " " + record.customer.lastname  >
                    </#if>
                    <td font-size="8pt"><b>Razón social:</b> ${razonSocial}</td>
                </tr>
                <tr>
