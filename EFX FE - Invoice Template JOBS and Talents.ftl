...
<pdf>
    ...
    <#--  <#assign "desglose_json_body" = {"ieps_total":"0.00","iva_total":"24.00","retencion_total":"0.00","local_total":"-5.00","exento_total":"0.00","ieps_total_gbl":"0.00","iva_total_gbl":"24.00","retencion_total_gbl":"0.00","local_total_gbl":"-5.00","exento_total_gbl":0,"rates_ieps":{},"rates_ieps_data":{},"bases_ieps":{},"rates_iva":{"IVA 16%":"24.00"},"rates_iva_data":{"16":"24.00"},"bases_iva":{"16":"150.00"},"rates_retencion":{},"rates_retencion_data":{},"bases_retencion":{},"rates_local":{"Local -5%":"-5.00"},"rates_local_data":{"-5":{"monto":"40.00","nombre":"3%_EDOMEX ISN"}},"bases_local":{"-5":"100.00"},"rates_exento":{},"rates_exento_data":{},"bases_exento":{},"monto_ieps_gbl":{},"monto_iva_gbl":{"16":"24.00"},"monto_ret_gbl":{},"monto_local_gbl":{"-5":"40.00"},"monto_exento_gbl":{},"descuentoConImpuesto":"0.00","descuentoSinImpuesto":"0.00","totalImpuestos":"21.00","subtotal":"150.00","total":"171.00","totalTraslados":"21.00","totalRetenciones":"0.00","diferenciaTotales":"0.00","totalImpuestos_gbl":"21.00","subtotal_gbl":"150.00","total_gbl":"171.00","totalTraslados_gbl":"21.00","totalRetenciones_gbl":"0.00"}>  -->
    ...
    <table class="body" style="width: 100%; margin-top: 9px;">
        ...
        <tr>
            <td colspan="3" style="font-size:9px;">${record.duedate}</td>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
                ...
                <#list dataXML.Conceptos.Concepto as Conceptos>
                    <tr>
                        ...
                        <td align="center" colspan="5" line-height="150%"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding:0;">${nsformat_rate(Conceptos.atributos.ClaveProdServ)?keep_after("$")}</td>
                                            ...
                                            <#if Conceptos.Impuestos.Traslados.Traslado?has_content>
                                                <#if Conceptos.Impuestos.Traslados.Traslado?is_sequence>
                                                        <#list Conceptos.Impuestos.Traslados.Traslado as traslado_imp>
                                                            <tr>
                                                                <td align="left" colspan="4"
                                                                    style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(traslado_imp.atributos.Base)?keep_after("$")}</td>
            ...
            <#else>
                ...
                <tr>
                    ...
                    <td align="center" colspan="5" line-height="150%"
                        style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding:0;">${nsformat_rate(dataXML.Conceptos.Concepto.atributos.ClaveProdServ)?keep_after("$")}</td>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="2" line-height="150%"
                                style="border-left: 0px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${nsformat_rate(line_number,"MXN")?keep_after("$")}</td>
                            <td align="center" colspan="4" line-height="150%"
                                        ...
                                        <td colspan="18" style="border-left: 1px; border-color: #e3e3e3;">
                                            ...
                                            <table style="width: 100%; margin-top: 0px; margin-bottom: 0px;">
                                                ...
                                                <#if desglose.ieps.name?has_content>
                                                    <tr>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.base_importe,"MXN")?keep_after("$")}</td>
                                                        <td align="left" colspan="4"
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.rate,"MXN")?keep_after("$")}
                                                            %
                                                        </td>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.importe,"MXN")?keep_after("$")}</td>
                                                    </tr>
                                                </#if>
                                                ...
                                                <#if desglose.iva.name?has_content>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.iva.base_importe,"MXN")?keep_after("$")}</td>
                                                        <td align="left" colspan="4"
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.iva.rate,"MXN")?keep_after("$")}
                                                            %
                                                        </td>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.iva.importe,"MXN")?keep_after("$")}</td>
                                                    </tr>
                                                </#if>
                            ...
                            <td align="center" colspan="2"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${units_sat}</td>
                            <td align="center" colspan="4" line-height="150%"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.quantity,"MXN")?keep_after("$")}</td>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.rate,"MXN")?keep_after("$")}</td>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.tax1amt,"MXN")?keep_after("$")}</td>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(importe_discount[item_index+1],"MXN")?keep_after("$")}</td>
                            <#assign "descuento_total" = descuento_total + importe_discount[item_index+1]>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.grossamt,"MXN")?keep_after("$")}</td>
                        </#if>
                    </tr>
    ...
    <#if desglose_json_body?has_content>
        ...
        <#assign "desglose_iva" = desglose_body.rates_iva>
        <#assign "desglose_ret" = desglose_body.rates_retencion>
        <#assign "retencion_total" = desglose_body.retencion_total?number>
    ...
    <table style="width: 100%; margin-top: 5px; padding: 0px; border: 1px; border-color: #e3e3e3; font-size: 7pt;">
        <tr>
            <td>El pago tardio de las cantidades a que se refiere esta factura, generará un interés moratorio del 6% (seis por ciento) mensual sobre saldos insolutos, mismo que se cobrará en la siguiente factura mensual.</td>
        </tr>
    </table>
        ...
        <tr>
            <td colspan="6" style="margin: 0px; padding: 0px;">
                <table class="total" style="width: 100%; margin-top: 0px; border: 0px; border-color: #e3e3e3;">
                    ...
                    <tr>
                        <td align="left"
                            style="border-right: 1px; border-bottom: 1px; border-color: #e3e3e3; font-size: 7pt;">
                            <strong>Lugar de expedición:</strong> ${record.custbody_efx_fe_lugar_expedicion}</td>
                        <td align="left"
            ...
            <td colspan="2" style="margin: 0px; padding: 0;">
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                        ...
                        <#else>
                            <#if record.custbody_efx_fe_gbl_subtotal?has_content>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;">${nsformat_rate(record.custbody_efx_fe_gbl_subtotal,"MXN")?keep_after("$")}</td>
                            <#else>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;">${nsformat_rate(record.subtotal,"MXN")?keep_after("$")}</td>
                            </#if>
                        </#if>
                    ...
                    <tr>
                        ...
                        <#else>
                            <#if descuento_total != 0>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;"><#if desglose_total_discount?has_content>${nsformat_rate(desglose_total_discount,"MXN")?keep_after("$")}</#if></td>
                            <#else>
                                <#if record.discounttotal != 0>
                                    <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(record.discounttotal,"MXN")?keep_after("$")}</td>
                                <#else>
                    ...
                    <#assign rate_traslados_locales = -1>
                    <#assign monto_traslados_locales = -1>

                    <#assign rate_retenciones_locales = 0>
                    <#assign monto_retenciones_locales = 0>
                        ...
                        <#if dataXML?has_content>
                            ...
                            <#else>
                                <#if desglose_json_body?has_content>
                                    ...
                                    <#if desglose_body.rates_local_data?has_content>
                                ...
                                <#list isn as key, value>
                                    <#if key?number gt 0>
                                        ...
                                        <#assign monto_traslados_locales = value.monto?number>

                                        <#else>
                                            <#assign rate_retenciones_locales = key?number>
                                            <#assign monto_retenciones_locales_timbrado = value.monto?number>
                                            <#--  <#assign monto_retenciones_locales = value.monto?number>  -->
                                    </#if>

                                </#list>
                                <#if rate_traslados_locales gt 0>
                                    <#assign total_trasla = monto_traslados_locales + totalivaGBL?number>
                                    <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(total_trasla,"MXN")?keep_after("$")}</td>
                                    <#else>
                                        <td align="right" colspan="1" style="font-size: 7pt; ">${nsformat_rate(totalivaGBL,"MXN")?keep_after("$")}</td>
                                </#if>
                        </#if>
                    </tr>
                                ...
                                <#if Iva_rate == "16" || Iva_rate == "0">
                                    <tr>
                                        <td colspan="2" style="font-size: 5pt; border-color: #e3e3e3;border-left: 1px;">
                                            ${Iva_rate}%: ${nsformat_rate(Iva_total,"MXN")?keep_after("$")}<br/>
                                        </td>
                                    </tr>
                                </#if>
                                <#if rate_traslados_locales gt 0>
                                    <tr>
                                        <td colspan="2" style="font-size: 5pt;">
                                            ${rate_traslados_locales}%: ${nsformat_rate(monto_traslados_locales,"MXN")?keep_after("$")}<br/>
                                        </td>
                                    </tr>
                                </#if>
                            </#list>
                    ...
                    <tr>
                        ...
                        <#else>
                            <#if rate_traslados_locales lt 0>
                                <#if monto_retenciones_locales_timbrado?has_content>
                                    <#assign total_retencion = monto_retenciones_locales_timbrado +  retencion_total?number>
                                <#else>
                                    <#assign total_retencion = 0>
                                </#if>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;">${total_retencion}</td>
                            <#else>
                                <td align="right" colspan="1"
                    ...
                    <tr>
                        ...
                        <#else>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;"><#if cabecera_total?has_content>${nsformat_rate(cabecera_total,"MXN")?keep_after("$")}</#if></td>
                        </#if>
    ...
    <table style="width: 100%; margin-top: 10px; padding: 0; border: 0px; border-color: #e3e3e3; font-size: 7pt;">
        <tr>
            <th>Datos para depósitos:</th>
        </tr>

        <#if certData?has_content>
            <tr>
                <td>
                    Banco: &nbsp; ${record.subsidiary.custrecord_lmry_banco_subsidiaria}
                </td>
            </tr>    
        <#else>
            <tr>
                <td>
                    Banco: &nbsp; ${subsidiary.custrecord_lmry_banco_subsidiaria}
                </td>
            </tr>    
        </#if>
        ...
        <#if certData?has_content>
            <tr>
                <td>
                    Clabe: &nbsp; ${record.subsidiary.custrecord_mx_clabe}
                </td>
            </tr>
        ...
        <#else>
            <tr>
                <td>
                    Clabe: &nbsp; ${subsidiary.custrecord_mx_clabe}
                </td>
            </tr>    
        </#if>
        ...
        <#if certData?has_content>
            <tr>
                <td>
                    Número de convenio: &nbsp; ${record.subsidiary.custrecord_mx_numero_convenio}
                </td>
            </tr>
        ...
        <#else>
            <tr>
                <td>
                    Número de convenio: &nbsp; ${subsidiary.custrecord_mx_numero_convenio}
                </td>
            </tr>    
        </#if>
        ...
        <tr>
            <td>
                Número de referencia: &nbsp; ${record.entity.custentity_mx_numero_referencia}
            </td>
        </tr>
        ...
        <table class="total" style="width: 100%; margin-top: 10px; border: 1px; border-color: #e3e3e3;">
            ...
            <tr>
                <td style="font-size:8px;" rowspan="3" width=" 72px" colspan="7">
                    <p style="font-size:8px;"><b>UUID: </b>${certData.custbody_mx_cfdi_uuid}</p>
                    <p style="font-size:8px;"><b>Cadena original</b><br/>${certData.custbody_mx_cfdi_cadena_original}
                    </p>
                    <p style="font-size:8px;"><b>Firma del CFDI</b><br/>${certData.custbody_mx_cfdi_signature}</p>
                    <p style="font-size:8px;" rowspan="1"><b>Firma del
