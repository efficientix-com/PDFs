...
<pdf>
                ...
                <table class="header" height="90px" style="width: 100%;">
                    <tr height="90px">
                            ...
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_info_location_pdf == true>
                                    <#if record.custbody_efx_fe_logoloc?has_content>
                                        ...
                                        <img height="75px" width="168px" src="${urldir}"/>
                                    </#if>
                                <#else>
                                ...
                                <#else>
                                    ...
                                    <#else>
                                        <#if infoEmpresa.logo@url?length != 0>
                                            <span><img height="90px"  width="130px" src="${infoEmpresa.logo@url}"/></span>
                                        <#elseif companyInformation.logoUrl?length != 0>
                                            <img height="75px" width="168px" src="${companyInformation.logoUrl}"/>
                                        </#if>
                                    </#if>
                                </#if>
                            </#if>
                        ...
                        <td colspan="6" align="center">
                            ...
                            <span class="nameandaddress" style="font-size: 9px; width: 40%;" >Departamento: ${record.department?upper_case}</span>
    ...
    <table class="body" style="width: 100%; margin-top: 9px;">
        <tr>
            <th colspan="5">Términos de crédito</th>
            <th colspan="5">Costo de Envio</th>
            <th colspan="5">Orden de venta</th>

        </tr>
        <tr>
            <td colspan="5" style="font-size:9px;">${record.entity.terms}</td>
            <td colspan="5" style="font-size:9px;">${nsformat_rate(record.shippingcost)?keep_after("$")}</td>
            <td colspan="5" style="font-size:9px;">${record.createdfrom?keep_after("#")}</td>
...
<td colspan= "18" style="width: 100%; font-size:10px;">${record.memo}</td>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="4" line-height="150%"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${item.custcol_efx_peso_unitario_bp?string["0.0000"]}</td>
                            <td align="center" colspan="4"
            ...
            <td colspan="2" style="margin: 0px; padding: 0;">
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                    ...
                    <tr>
                        ...
                        <#else>
                            <#assign json_desgloce = record.custbody_efx_fe_tax_json?eval>
                            <td align="right" colspan="1" style="font-size: 7pt;">${json_desgloce.totalTraslados}</td>
                        </#if>
                    </tr>
                    <#if dataXML?has_content>
                    ...
                    <tr>
                        ...
                        <#else>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;">${nsformat_rate(retencion_total)?keep_after("$")}</td>
                        </#if>
                    </tr>
    ...
    <table style="width: 680px; height: 50px; border: 1px dashed black; overflow: hidden; display: table;"><tr>
            <td style="width: 751px;"><br />DEBE(MOS) Y PAGARE(MOS) INCONDICIONALMENTE POR ESTE PAGARE A LA ORDEN DE Obra Nacional de la Buena Prensa AC<br />EN&nbsp; ${record.location}&nbsp; &nbsp; O EN CUALQUIER OTRA PLAZA A ELECCI&Oacute;N DE NUESTRO ACREEDOR POR E IMPORTE DE LAS MERCANC&Iacute;AS Y/O<br />POR LOS SERVICIOS RECIBIDOS A ENTERA SATISFACCI&Oacute;N.<br /><br />SI ESTE PAGARE NO FUERA CUBIERTO A SU VENCIMIENTO CAUSARA INTERESES MORATORIOS AL 5% MENSUAL SIN QUE POR<br />ESTO SE ENTIENDA PRORROGADO EL PLAZO.<br /><br />RECUERDE INFORMAR DE SU PAGO A credito@buenaprensa.com<br /><br />${record.trandate}&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;LA CANTIDAD DE:<br /><br />${record.custbody_efx_fe_monto_letra}<br /><br /><br />ACEPTAMOS:__________________________________________<br /><br />&nbsp;</td>
        </tr></table>
