...
<pdf>
                ...
                <table class="header" style="width: 100%;">
                    <tr rowspan="3">
                        ...
                        <td colspan="3" align="right">
                            <span style="text-align: right" class="title" >Recepción de<br /><span class="title">Artículos</span></span>
                        </td>
                    </tr>
                    <tr>
    ...
    <table style="width: 100%; margin-top: 10px;">
        <tr>
            <th class="addressheader" colspan="15">Información Primaria:</th>
        </tr>

        <tr>
            <td class="addressheader" colspan="3"><b>Proveedor: </b></td>
            <td class="addressheader" colspan="3"><b>Creado dese: </b></td>
            <td class="addressheader" colspan="3"><b>Período Contable:</b></td>
            <td class="addressheader" colspan="3"><b>Nota:</b></td>
            <td class="addressheader" colspan="3"><b>Fecha:</b></td>
        </tr>

        <tr>
            <td class="address" colspan="3" rowspan="2">${results.entity}</td>
            <td class="address" colspan="3" rowspan="2">${results.createdfrom}</td>
            <td class="address" colspan="3" rowspan="2">${results.postingperiod}</td>
            <td class="address" colspan="3" rowspan="2">${results.memo}</td>
