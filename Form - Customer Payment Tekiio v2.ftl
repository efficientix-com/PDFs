...
<pdf>
    ...
    <#else>
        <#assign nombreReceptor=record.customer.companyname>
    </#if>

    <#if record.custbody_csc_kiosko_rfc?has_content>
        <#assign rfcReceptor=record.custbody_csc_kiosko_rfc>
    <#else>
        <#assign rfcReceptor=record.customer.custentity_mx_rfc>
    </#if>
    ...
    <table style="width: 100%; margin-top: 10px;">
        ...
        <tr>
            <td colspan="9" style="padding: 0px; font-size: 8pt">${nombreReceptor}<br/>
                <span style="font-size:10px;">
                    <br/><strong>RFC:</strong>${rfcReceptor}</span>
            </td>
        ...
        <tr>
            ...
            <td>
                <table style="width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        <td style="align: left;">${certData.custbody_mx_cfdi_signatured}</td>
                    </tr>
                    <tr>
