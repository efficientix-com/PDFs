                                ...
                                <#else>
                                    ...
                                    <#else>
                                        <#if infoEmpresa.logo@url?length != 0>
                                            <span><img style="float: left; margin: 7px;" width="140" height="70" src="${infoEmpresa.logo@url}"/></span>
                                        <#elseif companyInformation.logoUrl?length != 0>
                                            <img style="float: left; margin: 7px;" width="140" height="70" src="${companyInformation.logoUrl}"/>
                                        </#if>
                                    </#if>
                                </#if>
                            </#if>
                ...
                <#list record.item as item>
                    ...
                    <#if tipo_articulo == "Discount">
                        <tr>
                            ...
                            <td colspan="42" line-height="150%" style="border-left: 1px; border-top: 1px;border-color: #e3e3e3; font-size: 5pt; padding-top: 1px;">
                                    ${item.description} <br />
                            </td>
                            <td colspan="8" line-height="150%" style="border-left: 1px; border-top: 1px;border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">0.00</td><!--importe_discount[item_index+1]?number?string[",##0.00"] -->
            ...
            <#if item.quantity?has_content>
                <#if record.custbody_efx_fe_complemento_educativo?has_content && record.custbody_efx_fe_complemento_educativo == true >
                    <tr>
                        <th align="center" colspan="56" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Complemento educativo</th>

                    </tr>
                    <tr>
                        <td colspan="56" style="font-size: 5pt;">
