...
<pdf>
    ...
    <table style="width: 100%; margin-top: 10px;"><tr>
        ...
        <tr>
            <td class="address" colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3;">${record.entity}<br/>${record.billaddress?cap_first}<br/>RFC: ${record.custbody_mx_customer_rfc}<br/>No. de Cliente: ${record.entity.entityid}<br/></td>
            <td></td>
    ...
    <table class="body" style="width: 100%; margin-top: 10px;"><tr>
        ...
        <tr>
            ...
            <td colspan="3" style="font-size:10px;">${record.shippingcost}</td>
