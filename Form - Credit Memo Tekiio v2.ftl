...
<pdf>
                ...
                <table style="width: 100%; font-size: 10pt;">
                    <tr>
                        ...
                        <#if record.custbody_efx_fe_info_location_pdf == true>
                            <#assign address= custbody_efx_fe_dirloc>
                            <#else>
    ...
    <#else>
        <#assign nombreReceptor=record.entity.companyname>
    </#if>

    <#if record.custbody_csc_kiosko_rfc?has_content>
        <#assign rfcReceptor=record.custbody_csc_kiosko_rfc>
    <#else>
        <#assign rfcReceptor=record.entity.custentity_mx_rfc>
    </#if>
    ...
    <table style="width: 100%; margin-top: 10px;">
        ...
        <tr>
            <td colspan="4" style="padding: 0px; width: 25%; font-size: 8pt">${nombreReceptor}<br/>
                <span style="font-size:10px;">
                    <br/><strong>RFC:</strong>${rfcReceptor}
                </span>
            </td>
            <td colspan="4" style="padding: 0px; width: 25%; font-size: 8pt">${direccionReceptor}</td>
            <td
                    align="right"
                    colspan="5"
