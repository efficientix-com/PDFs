        ...
        <macrolist>
            ...
            <macro id="nlheader">
                <table style="width: 100%; font-size: 10pt;">
                    <tr>
                        <td rowspan="3" style="padding: 5px; width: 33%;">
                ...
                <#if record.custbody_efx_fe_cancelled== true >
                    ...
                    <#else>
                        ...
                        <table style="width: 100%; margin-top: 10px;">
                            ...
                            <tr>
                                <td colspan="4" style="padding: 0px; width: 25%; font-size: 7pt">${record.entity.addressee}<br/>
                                    <span style="font-size:10px;">
                                        <strong>RFC:</strong>${record.entity.vatregnumber}</span>
                                </td>
                                <td colspan="4" style="padding: 0px; width: 25%; font-size: 7pt">${record.billaddress}</td>
                                <td
                                    align="right"
                                    colspan="5"
                                            ...
                                            <table class="itemtable" style="width: 100%; margin-top: 10px;">
                                                ...
                                                <#list record.item as item>
                                                    <#if item_index==0>
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th align="center" colspan="11" style="background-color: #999999; color: #fff;">${item.item@label}</th>
                                                              <th align="center" colspan="3" style="background-color: #999999; color: #fff;">Cód. Artículo</th>
                                                    ...
                                                    <tr style="font-size:8pt;">
                                                        ...
                                                        <td colspan="11">
                                                            <span class="itemname">Código: ${item.item}</span><br/>Descripción: ${item.description}<br/>Serie/Lote: ${item.custcol_efx_fe_serie_lote}</td>
                                                        <td colspan="3">Clave: ${item.custcol_efx_fe_clave_producto_sat}<br/>Unidad: ${item.custcol_efx_fe_unidad_medida_sat}</td>
