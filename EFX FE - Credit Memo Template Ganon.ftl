...
<pdf>
    ...
    <table style="width: 100%; margin-top: 10px;"><tr>
        ...
        <tr>
            <td class="address" colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3;">${record.entity}<br/>${record.billaddress?cap_first}<br/>RFC: ${record.custbody_mx_customer_rfc}<br/>No. de Cliente: ${record.entity.entityid}</td>
            <td></td>
            <td align="left" colspan="14" style="border: 1px; border-color: #e3e3e3;">${record.shipaddress} </td>
        </tr>
    </table>
...
<table class="body" style="width: 100%; margin-top: 10px;"><tr>
    ...
    <#if record.item?has_content><#assign "total_cajas" = 0><#assign "total_piezas" = 0>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 5px; border: 1px; border-color: #e3e3e3;"><#list record.item as item><#if item_index==0>
                ...
                <tr>
                    ...
                    <th align="center" colspan="3" style="font-size: 5pt;">Clave<br/>SAT</th>
                    <th align="left" colspan="2" style="font-size: 5pt;">Unidad</th>
                    <th align="left" colspan="4" style="font-size: 5pt;">UPC</th>
                    <th align="left" colspan="4" style="font-size: 5pt;">Cant.</th>
                    <th align="center" colspan="4" style="font-size: 5pt;">Precio<br/>sin impuesto</th>
                ...
                <tr>
                    ...
                    <td colspan="2" style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt;">${item.units}</td>
                    <td colspan="4" style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt;">${item.custcol_efx_fe_upc_code}</td>
                    <td align="center" colspan="4" line-height="150%" style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt;">${item.quantity}</td>
        ...
        <table class="total" style="width: 100%; margin-top: 10px; border: 1px; border-color: #e3e3e3;">
            ...
            <tr>
                <td align="left" style="border-right: 1px; border-bottom: 1px; border-color: #e3e3e3; font-size: 7pt;"><strong>Elaboró:</strong> ${record.custbody_efx_cmp_elaboro}</td>
    ...
    <#if certData?has_content>
        <table class="total" style="width: 100%; margin-top: 10px; border-left: 1px; border-color: #e3e3e3;"><tr>
            ...
            <#if record.custbody_efx_fe_related_cfdi_json?has_content>
                <tr>
                    <td style="border-left: 1px;border-right: 1px; border-color: #e3e3e3;font-size:90%;"><b>CFDI Relacionados</b></td>
                </tr>
                <#assign cfdiRel = record.custbody_efx_fe_related_cfdi_json>
                <#assign json=cfdiRel?eval />
                <#list json as item>
                    <tr>
                        <td style="border-left: 1px;border-right: 1px; border-color: #e3e3e3;font-size:90%;">${item.fol}</td>
                    </tr>
                    <tr>
                        <td style="border-left: 1px;border-right: 1px; border-color: #e3e3e3;font-size:90%;">${item.type}</td>
                    </tr>
                    <tr>
                        <td style="border-left: 1px;border-right: 1px; border-color: #e3e3e3;font-size:90%;">${item.uuid}</td>
                    </tr><br>
                </#list>
            </#if>
            <tr>
