        ...
        <table class="header" style="width: 100%;">
            <tr>
                <td colspan="6" rowspan="3">
                    ...
                    <img height="35%" src="${record.custbody_efx_fe_logosub}" style="float: left; width: 75px; height: 75px; padding-right: 20px;" />
                </#if>
                <#else>
                <#if record.custbody_efx_fe_logosub?has_content>
                <#if subsidiary.logo@url?length != 0>
                <img height="35%" src="${subsidiary.logo@url}" style="float: left; width: 75px; height: 75px; padding-right: 20px;" />
                <#elseif companyInformation.logoUrl?length != 0>
                <img height="35%" src="${companyInformation.logoUrl}" style="float: left; width: 75px; height: 75px; padding-right: 20px;" />
            </#if>
        </#if>
    </#if>
