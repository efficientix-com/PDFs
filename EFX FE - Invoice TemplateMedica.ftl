...
<br/> Regimen fiscal: ${record.subsidiary.custrecord_mx_sat_industry_type}
                        </td>
                        <td colspan="1">&nbsp;</td>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="2" line-height="150%"
                                style="border-left: 0px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${nsformat_rate(line_number)?keep_after("$")}</td>
                            <td align="center" colspan="4" line-height="150%"
