                            ...
                            <#list record.item as item>
                                ...
                                <#if item.itemtype!='Discount'>
                                    ...
                                    <#if item.custcol_tkio_notas_fact?has_content>
                                        <#assign data = item.custcol_tkio_notas_fact?replace(",", "<br />")>
                                        <#assign datafinal = data?replace(";", "<br />")>
                                        
                                        <#if datafinal?contains("<br />")>
                                            <#assign arrayFact = datafinal?split("<br />")>
                                        <#else>
                                    ...
                                    <#if item.custcol_tkio_notas_fact_2?has_content>
                                        <#assign data = item.custcol_tkio_notas_fact_2?replace(",", "<br />")>
                                        <#assign datafinal = data?replace(";", "<br />")>
                                        
                                        <#if datafinal?contains("<br />")>
                                            <#assign arrayFact2 = datafinal?split("<br />")>
                                        <#else>
                                    ...
                                    <#if item.custcol_tkio_notas_fact_3?has_content>
                                        <#assign data = item.custcol_tkio_notas_fact_3?replace(",", "<br />")>
                                        <#assign datafinal = data?replace(";", "<br />")>
                                        
                                        <#if datafinal?contains("<br />")>
                                            <#assign arrayFact3 = datafinal?split("<br />")>
                                        <#else>
                                        ...
                                        <#list arrayFact as n1>
                                            <tr style="font-size:6pt;">
                                                ...
                                                <td align="center" colspan="3" >
                                                    <#--  Cantidad array1: ${arrayFact?size} <br /> 
                                                    Cantidad array2: ${arrayFact2?size} <br /> 
                                                    Cantidad array3: ${arrayFact3?size} <br />   -->
                                                </td>
                                    ...
                                    <#else>
                                        <tr id="datos" style="font-size:6pt;">
                                            ...
                                            <td align="center" colspan="3" ></td>
                                            <td align="left" colspan="10" >
                                                    ${item.custcol_tkio_notas_fact} ${item.custcol_tkio_notas_fact_2} ${item.custcol_tkio_notas_fact_3} 
                                            </td>
                                            <td align="center" colspan="4" ></td>
                                            <td align="center" colspan="3" ></td>
                                            <td align="center" colspan="3" ></td>
