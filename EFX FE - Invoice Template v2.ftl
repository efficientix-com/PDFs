                    ...
                    <tr height="90px">
                            ...
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_info_location_pdf == true>
                                    <#if record.custbody_efx_fe_logoloc?has_content>
                                        ...
                                        <img src="${urldir}" style="float: left; margin: 5px;" width="160" height="60"/>
                                    </#if>
                                <#else>
                                ...
                                <#else>
                                    ...
                                    <#else>
                                        <#if infoEmpresa.logo@url?length != 0>
                                            <img src="${infoEmpresa.logo@url}" style="float: left; margin: 5px;" width="160" height="60"/>
                                        <#elseif companyInformation.logoUrl?length != 0>
                                            <img src="${companyInformation.logoUrl}" style="float: left; margin: 5px;" width="160" height="60"/>
                                        </#if>
                                    </#if>
                                </#if>
                            </#if>
                        ...
                        <td colspan="6" align="center">
                            ...
                            <span class="nameandaddress" style="font-size: 9px;">
                                VALORES PATRIMONIALES DM<br/>
                                <#if record.custbody_efx_fe_info_location_pdf == true>${record.custbody_efx_fe_dirloc}<#else>${record.custbody_efx_fe_dirsubs}</#if>
                                <br/>Régimen General de Ley Personas Morales
                            </span>
...
<td colspan= "18" style="width: 100%; font-size:10px;">${record.memo}</td>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#list record.item as item><#if item_index==0>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Cuenta <br/> Predial
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Precio
                        sin<br/>impuesto
                    </th>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${item.custcol_mx_txn_line_sat_cadastre_id}</td>
                            <td align="center" colspan="4"
    ...
    <table style="width: 100%; margin-top: 10px; padding: 0; border: 0px; border-color: #e3e3e3;">
        ...
        <tr>
            ...
            <td colspan="1" style="font-size: 7pt; padding: 2px;"><b>Exportación:</b></td>
            <td colspan="2" style="font-size: 7pt; padding: 2px;">NO APLICA</td>
        </tr>
        <tr>
    ...
    <#if certData?has_content>
        ...
        <table class="total" style="width: 100%; margin-top: 10px; border: 1px; border-color: #e3e3e3;">
            ...
            <tr>
                <td style="font-size:7px;" rowspan="3" width=" 72px" colspan="7">
                    <p style="font-size:7px;"><b>UUID: </b>${certData.custbody_mx_cfdi_uuid}</p>
                    <p style="font-size:7px;"><b>RFC: </b>
                    <#if dataXML?has_content>
                        ${dataXML.Complemento.TimbreFiscalDigital.atributos.RfcProvCertif}
                    </#if>
                    </p>
                    <p style="font-size:7px;"><b>Cadena original</b><br/>${certData.custbody_mx_cfdi_cadena_original}
                    </p>
                    <p style="font-size:7px;"><b>Firma del CFDI</b><br/>${certData.custbody_mx_cfdi_signature}</p>
                    <p style="font-size:7px;" rowspan="1"><b>Firma del SAT</b><br/>${certData.custbody_mx_cfdi_sat_signature}</p>
                </td>
            </tr>
        </table>
    </#if>
