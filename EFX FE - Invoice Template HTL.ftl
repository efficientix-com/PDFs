                                            ...
                                            <table style="width: 100%; margin-top: 0px; margin-bottom: 0px;">
                                                ...
                                                <#if desglose.ieps.name?has_content>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.rate)?keep_after("$")}
                                                            %
                                                        </td>
                                                        <td align="left" colspan="4"
                                                ...
                                                <#if desglose.iva.name?has_content>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.iva.rate)?keep_after("$")}
                                                            %
                                                        </td>
                                                        <td align="left" colspan="4"
                ...
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                    ...
                    <tr>
                        ...
                        <#if desglose_json_body?has_content>
                            ...
                            <td align="right" colspan="1" style="font-size: 7pt; ">${nsformat_rate(desglose_body.iva_total)?keep_after("$")}</td>
