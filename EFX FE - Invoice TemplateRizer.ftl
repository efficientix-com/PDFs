            ...
            <macro id="nlheader">
                <table class="header" height="90px" style="width: 100%;">
                    <tr height="90px">
                            ...
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_info_location_pdf == true>
                                    <#if record.custbody_efx_fe_logoloc?has_content>
                                        ...
                                        <img height="75px" width="180px" src="${urldir}"/>
                                    </#if>
                                <#else>
                                ...
                                <#else>
                                    ...
                                    <#else>
                                        ...
                                        <#elseif companyInformation.logoUrl?length != 0>
                                            <img height="75px" width="180px" src="${companyInformation.logoUrl}"/>
                                        </#if>
                                    </#if>
                                </#if>
                            </#if>
                        ...
                        <td colspan="1">&nbsp;</td>
                        <td colspan="6" style="font-size: 10px;" align="right"><span style="font-size: 12px;"><strong>FACTURA</strong></span><br/>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
                ...
                <#list dataXML.Conceptos.Concepto as Conceptos>
                    <tr>
                                                ...
                                                <#if Conceptos.Impuestos.Traslados.Traslado?is_sequence>
                                                        <#list Conceptos.Impuestos.Traslados.Traslado as traslado_imp>
                                                            <tr>
                                                                ...
                                                                <td align="left" colspan="4"
                                                                    style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(tasa_line)?keep_after("$")}
                                                                    %
                                                                </td>
                                                                <td align="left" colspan="4"
                                                                    style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(traslado_imp.atributos.Importe)?keep_after("$")}</td>
                                                            </tr>
                                                        </#list>
                                                    <#else>
                                                        <tr>
                                                            <td align="left" colspan="4"
                                                                style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(Conceptos.Impuestos.Traslados.Traslado.atributos.Base)?keep_after("$")}</td>
                                                            <td align="left" colspan="2"
                                                            ...
                                                            <td align="left" colspan="4"
                                                                style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(Conceptos.Impuestos.Traslados.Traslado.atributos.Importe)?keep_after("$")}</td>
                                                        </tr>
                                                </#if>
                                            </#if>
                                            ...
                                            <#if Conceptos.Impuestos.Retenciones.Retencion?has_content>
                                                <#if Conceptos.Impuestos.Retenciones.Retencion?is_sequence>
                                                    <#list Conceptos.Impuestos.Retenciones.Retencion as ret_imp>
                                                        <tr>
                                                            <td align="left" colspan="4"
                                                                style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(ret_imp.atributos.Base)?keep_after("$")}</td>
                                                            <td align="left" colspan="2"
                                                            ...
                                                            <td align="left" colspan="4"
                                                                style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(ret_imp.atributos.Importe)?keep_after("$")}</td>
                                                        </tr>
                                                    </#list>
                                                <#else>
                                                    <tr>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(Conceptos.Impuestos.Retenciones.Retencion.atributos.Base)?keep_after("$")}</td>
                                                        <td align="left" colspan="2"
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(Conceptos.Impuestos.Retenciones.Retencion.atributos.Importe)?keep_after("$")}</td>
                                                    </tr>
                                                </#if>
                                            </#if>
                                        </table>
                        ...
                        <td align="center" colspan="4" line-height="150%"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(Conceptos.atributos.Cantidad)?keep_after("$")}</td>
                        <td align="center" colspan="4"
                            style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(Conceptos.atributos.ValorUnitario)?keep_after("$")}</td>
                        ...
                        <td align="center" colspan="4"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(impuestos_line_calc)?keep_after("$")}</td>
                        <td align="center" colspan="4"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(Conceptos.atributos.Descuento)?keep_after("$")}</td>
                        <td align="center" colspan="4"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(Conceptos.atributos.Importe)?keep_after("$")}</td>
                    </tr>
            ...
            <#else>
                ...
                <tr>
                    ...
                    <td align="center" colspan="4" line-height="150%"
                        style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(dataXML.Conceptos.Concepto.atributos.Cantidad)?keep_after("$")}</td>
                    <td align="center" colspan="4"
                        style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(dataXML.Conceptos.Concepto.atributos.ValorUnitario)?keep_after("$")}</td>
                    <#assign impuestos_line_calc = 0>
                    <#if Conceptos.Impuestos.Traslados.Traslado?has_content>
                        <#if Conceptos.Impuestos.Traslados.Traslado?is_sequence>
                            <#list Conceptos.Impuestos.Traslados.Traslado as impuestos_linec>
                    ...
                    <td align="center" colspan="4"
                        style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(impuestos_line_calc)?keep_after("$")}</td>
                    <td align="center" colspan="4"
                        style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(dataXML.Conceptos.Concepto.atributos.Descuento)?keep_after("$")}</td>
                    <td align="center" colspan="4"
                        style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(dataXML.Conceptos.Concepto.atributos.Importe)?keep_after("$")}</td>
                </tr>
            </#if>
        </table>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(importe_discount[item_index+1])?keep_after("$")}</td>
            ...
            <td colspan="2" style="margin: 0px; padding: 0;">
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                    <tr>
                        ...
                        <#if dataXML?has_content>
                            <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(dataXML.atributos.SubTotal)?keep_after("$")}</td>
                        <#else>
                    ...
                    <tr>
                        <td colspan="1" style="font-size: 7pt;  border-color: #e3e3e3;border-left: 1px;">
                            <b>Descuento</b></td>
                        <#if dataXML?has_content>
                            <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(dataXML.atributos.Descuento)?keep_after("$")}</td>
                        <#else>
                    ...
                    <tr>
                        ...
                        <#if dataXML?has_content>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;">${nsformat_rate(dataXML.Impuestos.atributos.TotalImpuestosTrasladados)?keep_after("$")}</td>
                        <#else>
                        <#if desglose_json_body?has_content>
                            <#assign "desglose_body" = desglose_json_body?eval>
                            <#assign "iva_total" = desglose_body.iva_total>
                                ...
                                <#assign iva_ratenum = traslados_lista.atributos.TasaOCuota?number * 100>
                                    <tr>
                                        <td colspan="2" style="font-size: 5pt;">
                                            ${iva_ratenum}%: ${nsformat_rate(traslados_lista.atributos.Importe)?keep_after("$")}<br/>
                                        </td>
                                    </tr>
                            </#list>
                            <#else>
                                ...
                                <tr>
                                    <td colspan="2" style="font-size: 5pt;">
                                        ${iva_ratenum}%: ${nsformat_rate(dataXML.Impuestos.Traslados.Traslado.atributos.Importe)?keep_after("$")}<br/>
                                    </td>
                                </tr>
                        </#if>
                    ...
                    <tr>
                        ...
                        <#if dataXML?has_content>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;">${nsformat_rate(dataXML.Impuestos.atributos.TotalImpuestosRetenidos)?keep_after("$")}</td>
                        <#else>
                            <td align="right" colspan="1"
                    ...
                    <tr>
                        ...
                        <#if dataXML?has_content>
                            <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(dataXML.atributos.Total)?keep_after("$")}</td>
                        <#else>
                            <td align="right" colspan="1"
