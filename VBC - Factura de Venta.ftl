...
<pdf>
                            ...
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_info_location_pdf == true>
                                    <#if record.custbody_efx_fe_logoloc?has_content>
                                        ...
                                        <img height="70px" width="140" src="${urldir}"/>
                                    </#if>
                                <#else>
                                ...
                                <#else>
                                    ...
                                    <#else>
                                        <#if infoEmpresa.logo@url?length != 0>
                                            <span style=" width: 140px; height: 70px;"><img src="${infoEmpresa.logo@url}"/></span>
                                        <#elseif companyInformation.logoUrl?length != 0>
                                       <span style="width: 140px; height: 70px;">   <img src="${companyInformation.logoUrl}"/>  </span>
                                        </#if>
                                    </#if>
                                </#if>
                            </#if>
    ...
    <#if dataXML?has_content>
        <#if record.custbody_efx_fe_kiosko_customer?has_content>
            <table style="width: 100%; margin-top: 10px;">
                <tr>
                    <td class="body" colspan="14" style="background-color: #e3e3e3; font-size:9px;"><b>Cliente/Customer  </b></td>
                    <td></td>
        ...
        <#if record.custbody_efx_fe_kiosko_customer?has_content>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td></td>
                    <td align="left" colspan="14"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">${record.shipaddress} </td>
                </tr>
            </table>
        <#else>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td align="left" colspan="14"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">${record.shipaddress?keep_after(" />")?upper_case} </td>
                </tr>
            </table>
        </#if>
    </#if>
    ...
    <table class="body" style="width: 100%; margin-top: 9px;">
        <tr>
            <th colspan="3">Términos/Credit Terms </th>
            <th colspan="3">Referencia cliente/Refrence</th>
            <th colspan="3">Orden de venta/Bill of Sale</th>
            <th colspan="3">  </th>
            <th colspan="3"># Pedido/Order #</th>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#if dataXML.Conceptos.Concepto?is_sequence>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                                ...
                                <td colspan="18" style="border-left: 1px; border-color: #e3e3e3;">
                                    <table style="width: 100%; margin-top: 0px; margin-bottom: 0px;">
                                        ...
                                        <td align="left" colspan="4"
                                            style="font-size: 4pt; padding-top: 0px; padding-bottom: 0px;">Subtotal:
                                        </td>
                                        <td align="left" colspan="2"
                                            style="font-size: 4pt; padding-top: 0px; padding-bottom: 0px;">:
                                        </td>
                                        <td align="left" colspan="2"
                                            style="font-size: 4pt; padding-top: 0px; padding-bottom: 0px;">
                                        </td>
                                        <td align="left" colspan="4"
                                            style="font-size: 4pt; padding-top: 0px; padding-bottom: 0px;">Importe de impuestos:/Tax amount
                                        </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <th align="center" colspan="2"
                        style="font-size: 4pt; padding-left: 0px; padding-right: 0px;">Unidad/Unit
                    </th>
                    <th align="center" colspan="5"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Nota/Memo
                    </th>
                    <th align="center" colspan="4"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Piezas/Pieces
                    </th>
                    <th align="center" colspan="4"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Precio sin<br/>Impuesto/Tax
                    </th>
                    <th align="center" colspan="4"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Impuesto/Tax
                    </th>
                    <th align="center" colspan="4"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Descuento/Discount
                    </th>
                    <th align="center" colspan="4"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Importe/Total
                    </th>
                </tr>
                </thead>
                <#list dataXML.Conceptos.Concepto as Conceptos>
                    <tr>
                        ...
                        <#if Conceptos.Impuestos.Retenciones.Retencion?has_content>
                            ...
                            <#else>
                                <#assign impuestos_line_calc = impuestos_line_calc - Conceptaos.Impuestos.Retenciones.Retencion.atributos.Importe?number>
                            </#if>
                        </#if>
                        <td align="center" colspan="4"
            ...
            <#else>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="5" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Nota/Memo
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Piezas/Pieces
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Precio/Price
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Impuesto/Tax
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Descuento/Discount
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Importe/Total
                    </th>
                </tr>
                </thead>
                    ...
                    <td colspan="18" style="margin: 0; padding: 0;">
                        <table style="width: 100%">
                            ...
                            <#if dataXML.Conceptos.Concepto.InformacionAduanera.NumeroPedimento?has_content>
                                <tr style="padding:0px 0px;">
                                    <td colspan="6" style="font-size: 4pt; padding-top: 1px;  padding-bottom: 1px;"><b>Pedimento:/Order:</b>
                                    </td>
                                    <td colspan="13"
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#list record.item as item><#if item_index==0>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="3" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">
                        Código
                    </th>
                    <th align="center" colspan="3" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Código<br/>Clave
                    </th>
                    <th align="center" colspan="18" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">
                        <table style="width: 100%; margin-top: 0px; margin-bottom: 0px; border: 1px; border-color: #e3e3e3">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="4"
                                    style="font-size: 4pt; padding-top: 0px; padding-bottom: 0px; margin-top: 0px">Impuesto:/Tax:
                                </td>
                                <td align="left" colspan="2"
                                    style="font-size: 4pt; padding-top: 0px; padding-bottom: 0px;">
                                </td>
                    ...
                    <th align="center" colspan="2" style="font-size: 4pt; padding-left: 0px; padding-right: 0px;">Unidad/Units
                    </th>
                  
                    <th align="center" colspan="3" style="font-size: 4pt; padding-left: 0px; padding-right: 0px;">Piezas por caja/pieces per box
                    </th>
                    <th align="center" colspan="8" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Nota/Memo
                    </th>
                    <th align="center" colspan="3" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Piezas/Pieces
                    </th>
                    <th align="center" colspan="4" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Precio/Price
                    </th>
                    ...
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                            ...
                            <td colspan="18" style="margin: 0; padding: 0;">
                                <table style="width: 100%">
                                    ...
                                    <#if item.custcol_mx_txn_line_sat_cust_req_num?has_content>
                                        <tr style="padding:0px 0px;">
                                            <td colspan="6"
                                                style="font-size: 4pt; padding-top: 1px;  padding-bottom: 1px;"><b>Pedimento:/Order:</b>
                                            </td>
                                            <td colspan="13"
                            ...
                            <td align="center" colspan="2"
                                ...
                                <td align="center" colspan="2"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${item.custcol_tko}</td>
                            <td align="center" colspan="8"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${item.custcol1}</td>
                            <td align="center" colspan="3" line-height="150%"
                            ...
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${item.rate?string[",##0.00000"]}</td>
    ...
    <#if record.custbody_efx_fe_detalle_imp_loc?has_content>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <thead>
            <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                <th align="center" colspan="2" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Impuesto Local/Local Tax</th>
                <th align="center" colspan="2" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Tasa/Rate</th>
                <th align="center" colspan="2" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Porcentaje/%</th>
                <th align="center" colspan="2" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Importe/Total</th>
            </tr>
            </thead>
                ...
                <table class="total" style="width: 100%; margin-top: 0px; border: 0px; border-color: #e3e3e3;">
                    ...
                    <tr>
                        <td align="left"
                            ...
                            <strong>Vendedor/Sales Rep:</strong> ${record.salesrep?upper_case}</td>
                        <td align="left"
                ...
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                    ...
                    <tr>
                        <td colspan="1" style="font-size: 7pt;  border-color: #e3e3e3;border-left: 1px;">
                            <b></b></td>
                        <#if dataXML?has_content>
                            <td align="right" colspan="1" style="font-size: 7pt;"> </td>
                        <#else>
                            <#if descuento_total != 0>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;"><#if desglose_total_discount?has_content> </#if></td>
                            <#else>
                    ...
                    <tr>
                        <td colspan="1" style="font-size: 7pt;  border-color: #e3e3e3;border-left: 1px;"><b>Impuestos/Taxes</b></td>
                        <#if dataXML?has_content>
                            <td align="right" colspan="1"
    ...
    <table style="width: 100%; margin-top: 10px; padding: 0; border: 0px; border-color: #e3e3e3;">
        <tr>
            <th colspan="6">Detalles del comprobante/Details</th>
        </tr>
        <tr>
            ...
            <td colspan="1" style="font-size: 7pt; padding: 2px;"><b>Forma de pago:/Payment Method:</b></td>
            <#if forma_pago == "01">
        ...
        <tr>
            <td colspan="1" style="font-size: 7pt;"><b>Moneda:/Currency:</b></td>
    ...
    <#if certData?has_content>
        ...
        <table class="total" style="width: 100%; margin-top: 10px; border: 1px; border-color: #e3e3e3;">
          ...
          <table>
                    <#if (record.custbodymvo_seguro_interno_vbc==true)>
                        <tr>
                            <td style="font-size: 7pt; padding: 2px;"><!-- seguro-->
                                ${record.custbody2}
                            </td>
                        </tr>
                    </#if>
                    <#if (record.custbody1==false)>
                        <tr>
                            <td style="font-size: 7pt; padding: 2px;"> <!-- DEVOLUCIONES-->
